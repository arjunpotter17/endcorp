  ...
  return (
    <div className="flex max-w-[1100px] flex-col w-full justify-center items-start py-[75px] gap-y-[50px] font-end-regular px-4 end-md:px-10">
      ...
      <div className="flex gap-x-5 items-center">
        ...
        <div>
          <p onClick={() => window.open("https://www.ukspaceaccelerator.co.uk/leo", "_blank")} className="text-end-light-blue  hover:underline cursor-pointer text-[20px] end-md:text-[30px] text-left font-end-bold">
      ...
      <div className="flex gap-x-5 items-center">
        ...
        <div>
        <p onClick={() => window.open("https://x-ender.space", "_blank")} className="text-end-light-blue hover:underline cursor-pointer text-[20px] end-md:text-[30px] text-left font-end-bold">
          X-Ender Space
        </p>
        <p className="text-[14px] end-md:text-[20px] text-white">
          Experts in enabling Autonomy of fleets of machines, E-Ender Space and
          END Corp. have a close working relationship and MOU in place to
          solidify our partnership in bringing secure data protocols to space to
